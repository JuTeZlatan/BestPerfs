...
const ICON_RUNNING = '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6l6 6-6.5 6"/><path d="M13.5 6l6 6-6.5 6"/></svg>';
...
const ICON_CYCLING = '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="5.5" cy="17.5" r="3.5"/><circle cx="18.5" cy="17.5" r="3.5"/><path d="M5.5 17.5 12 10l6.5 7.5M12 10l-3 7.5"/></svg>';
...
const ICON_FITNESS = '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><line x1="7.5" y1="12" x2="16.5" y2="12" stroke-width="2"/><line x1="5" y1="9" x2="5" y2="15" stroke-width="4"/><line x1="19" y1="9" x2="19" y2="15" stroke-width="4"/><line x1="3" y1="10.5" x2="3" y2="13.5" stroke-width="2.4"/><line x1="21" y1="10.5" x2="21" y2="13.5" stroke-width="2.4"/></svg>';
